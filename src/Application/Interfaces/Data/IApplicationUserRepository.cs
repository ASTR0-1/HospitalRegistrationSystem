...
public interface IApplicationUserRepository
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the paged list of application
    ///     users.
    /// </returns>
    Task<PagedList<ApplicationUser>> GetApplicationUsersAsync(PagingParameters paging, string? searchQuery, string role,
        int? hospitalId = null);
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the identity result of the update
    ///     operation.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the identity result of the
