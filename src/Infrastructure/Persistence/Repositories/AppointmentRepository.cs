...
public class AppointmentRepository : RepositoryBase<Appointment>, IAppointmentRepository
{
    ...
    /// <inheritdoc />
    public Task<PagedList<Appointment>> GetIncomingAppointmentsByUserIdAsync(PagingParameters paging, int userId,
    ...
    /// <inheritdoc />
    public async Task<PagedList<Appointment>> GetAppointmentsByUserIdAsync(PagingParameters paging, int userId,
